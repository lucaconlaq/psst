  ...
  return (
    <Box flexDirection="column">
      <Box marginBottom={2} flexDirection="column">
        ...
        <Text>
          <Text color="yellow">psst {"<any command>"}</Text> - Runs any command
          with your secrets injected into its environment
        </Text>
      </Box>
      <Box marginBottom={2} flexDirection="column">
      ...
      <Box marginBottom={2} flexDirection="column">
        ...
        <Text>
          <Text color="yellow">p</Text> - Toggle password visibility for
          selected secret
        </Text>
        <Text>
