...
import type { SecretsConfig, SecretConfig } from "../types.js";
...
const Console = ({ config, configFile, sources }: ConsoleProps) => {
	...
	const handleSaveSecret = (previousName: string | null, name: string, secret: SecretConfig): void => {
		...
		<Box flexDirection="column">
			...
			{currentView === "editing" && (
				<Editor
					...
					secret={editingKey ? currentConfig[editingKey] : { source: "manual" as const, value: "" }}
					sources={sources}
